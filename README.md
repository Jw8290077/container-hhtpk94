...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hhtpk94.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hhtpk94.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jw8290077/container-hhtpk94.git
cd container-hhtpk94
```
...
```
docker attach container-hhtpk94
```
